...
// Badges read the dictionary, so they live in a client component; re-exported here so
// call sites keep a single import.
export { StatusBadge, CoverageCell } from "./StatusBadge";
...
export function ProgressBar({
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      {showPct && <span className="w-12 shrink-0 text-end text-xs text-slate-500 tabular">{formatPercent(pct, 0)}</span>}
    </div>
  );
}
